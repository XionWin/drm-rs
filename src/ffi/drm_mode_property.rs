...
pub struct DrmModePropertyPtr {
    ...
    pub(crate) enums: *const DrmModePropertyEnumPtr
}

#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct DrmModePropertyEnumPtr {
...
extern "C" {
    pub(crate) fn drmModeGetProperty(fd: libc::c_int, property_id: libc::c_uint) -> *const DrmModePropertyPtr;
